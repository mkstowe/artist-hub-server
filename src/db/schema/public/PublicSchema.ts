...
import type { default as DropdownCategoryTable } from './DropdownCategory';
import type { default as DropdownOptionTable } from './DropdownOption';
...
export default interface PublicSchema {
  dropdown_category: DropdownCategoryTable;

  dropdown_option: DropdownOptionTable;
